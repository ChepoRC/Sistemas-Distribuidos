...
public class Application extends Controller {
    ...
    */
    public static Result getConversionACentigrados(int fahrenheit){
        ObjectNode result = Json.newObject();
        result.put("centigrados", (fahrenheit-32)/1.8);
        return ok(result);
    }
    ...
    */
    public static Result getEmbajada(String pais){
        ...
        embajadas.put("Francia", "48.8648275,2.292344");
        embajadas.put("Portugal", "38.7375761,-9.2019543");
        ...
        embajadas.put("Austria", "48.1998585,16.3700744");
